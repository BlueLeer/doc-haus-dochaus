...
# --demo seeds a fictional Chongqing labor-dispute case before launch, so a first
# run can verify Chinese extraction and the labor workflow without uploading data.
DEMO=
for arg in "$@"; do
  [ "$arg" = "--demo" ] && DEMO=1
done
