...
// specifies CLS pooling for BGE-M3's dense representation. Queries embed raw;
// chunks were embedded with a document › section breadcrumb prepended (see
// embed.ts), which only the document side carries. BGE-M3 needs no query
// instruction prefix.
const MODEL = "onnx-community/bge-m3-ONNX"
const DIM = 1024
